...
void func1(int arg1, int arg2, int arg3)
{
    ...
    // arg1, arg2, arg3를 스택에 push
    call_stack[++SP] = arg3;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "arg3");
    call_stack[++SP] = arg2;
    stack_info[SP][0] = '\0';
    ...
    call_stack[++SP] = FP;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "func1 SFP");
    // 현재 스택 프레임을 FP에 저장
    FP = SP;
    // var_1을 스택에 push
    call_stack[++SP] = var_1;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "var_1");
...
void func3(int arg1)
{
    ...
    call_stack[++SP] = FP;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "func3 SFP");
    // 현재 스택 프레임을 FP에 저장
    FP = SP;
    // var_3를 스택에 push
    call_stack[++SP] = var_3;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "var_3");
    // var_4를 스택에 push
    call_stack[++SP] = var_4;
    stack_info[SP][0] = '\0';
    sprintf_s(stack_info[SP], sizeof(stack_info[SP]), "%s", "var_4");
